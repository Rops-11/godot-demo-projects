...
@onready var _game_on_authenticate_button: Button = %GameOnAuthenticateButton
@onready var _start_button: Button = %StartButton
@onready var _instructions_button: Button = %InstructionsButton


func _ready() -> void:
	_game_on_authenticate_button.pressed.connect(_on_connect_pressed)
...
func _update_ui_for_status(status: String) -> void:
	match status:
		"idle":
			_game_on_authenticate_button.disabled = false
			_start_button.visible = false
			_instructions_button.visible = false
			_status_label.text = "Press Connect to begin"
		"connecting":
			_game_on_authenticate_button.disabled = true
			_game_on_authenticate_button.text = "Connect Platform Account"
			_start_button.visible = false
			_instructions_button.visible = false
			_status_label.text = "Opening sign-in page..."
		"pending":
			_game_on_authenticate_button.disabled = true
			_game_on_authenticate_button.text = "Connecting..."
			_start_button.visible = false
			_instructions_button.visible = false
			_status_label.text = "Sign-in pending..."
		"authorized":
			_game_on_authenticate_button.visible = false
